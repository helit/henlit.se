...
var WholeNote = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].img.withConfig({
  ...
  return props.note == 'C' && '68px' || props.note == 'D' && '61px' || props.note == 'E' && '54px' || props.note == 'F' && '47px' || props.note == 'G' && '40px' || props.note == 'A' && '33px' || props.note == 'B' && '26px';
}, function (props) {
...
//# sourceMappingURL=music.js.36fd12c897d0d9fac89e.hot-update.js.map