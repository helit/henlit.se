...
var WholeNote = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].img.withConfig({
  ...
  return props.note == 'C' && '68px' || props.note == 'D' && '61px' || props.note == 'E' && '54px' || props.note == 'F' && '46px' || props.note == 'G' && '39px' || props.note == 'A' && '31px' || props.note == 'B' && '24px';
}, function (props) {
  return props.index > 0 ? "".concat(155 + 35 * props.index, "px") : '155px';
});
...
//# sourceMappingURL=music.js.f843cd4a4d97a807d0a7.hot-update.js.map